...
cmake -S "$ROOT" -B "$BUILD_DIR" \
    ...
    -DCMAKE_HIP_COMPILER="${CMAKE_HIP_COMPILER:-/opt/rocm/core-7.14/lib/llvm/bin/clang++}" \
    -DCMAKE_HIP_COMPILER_ROCM_ROOT="${CMAKE_HIP_COMPILER_ROCM_ROOT:-/home/sopdet/.local/rocm-staging}" \
